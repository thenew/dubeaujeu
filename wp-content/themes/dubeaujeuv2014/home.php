...
<g class="hitbox"><circle class="circle" fill="transparent" stroke="#333333" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="50" cy="50" r="10"/><circle class="disc" fill="#333333" cx="50" cy="50" r="5"/></g>
    ...
    <div class="content">
        ...
        <!-- <div class="intro">
            <em>Du Beau Jeu</em> a pour but de partager le plus beau du monde du jeu vidéo et promouvoir ses artistes.<br>
            En attandant, suivez-nous sur <a href="http://twitter.com/dubeaujeu">twitter</a>.<br>
            シ
        </div> -->
    </div>
</div>
